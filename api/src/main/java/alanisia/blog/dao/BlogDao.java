...
public interface BlogDao {
  @Insert("insert into blog(account_id, category_id, title, content, like, star" +
   "values(#{blog.accountId}, #{blog.categoryId}, #{blog.title}, #{blog.content}, #{blog.like}, #{blog.star}")
